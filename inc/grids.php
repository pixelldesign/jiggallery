...
class JIG_Grids
{
    ...
    public function setup_grid_cpt()
    {
        $args = array(
            ...
            'register_meta_box_cb'  => array($this, 'box_cb'),
        );
        \register_post_type($this->cpt_name, $args);

        add_action('wp_ajax_jig_preview', [$this, 'jig_preview']);
        add_action('admin_enqueue_scripts', [$this, 'enqueue_scripts_cpt_edit_screen']);
    }
        ...
        <div id="jig-wrap">
            <div id="jig-top">
                ...
                <div id="jig-top-right">
                    <input type="text" readonly id="jig-shortcode" value="[justified_image_grid gallery=123456]">
...
<?php
    ...
    function enqueue_scripts_cpt_edit_screen($hook_suffix)
    {
